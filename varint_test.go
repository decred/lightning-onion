...
// TestWriteVarInt asserts the behavior of WriteVarInt under various positive
...
func testWriteVarInt(t *testing.T, test varIntTest) {
	...
	err := WriteVarInt(&w, test.Value, &buf)
	if err != nil {
...
// TestReadVarInt asserts the behavior of ReadVarInt under various positive and
// negative test cases.
